...
public class CookInfo {
    ...
    public static class ResultBean {
        ...
        public static class DataBean {
            ...
            public DataBean(String id, String title, String tags, String imtro, String ingredients, String burden, List<String> albums, List<StepsBean> steps) {
                this.id = id;
                this.title = title;
                this.tags = tags;
                this.imtro = imtro;
